...
type SportClient interface {
	...
	ListEvents(ctx context.Context, in *ListEventRequest, opts ...grpc.CallOption) (*ListEventsResponse, error)
}
...
func (c *sportClient) ListEvents(ctx context.Context, in *ListEventRequest, opts ...grpc.CallOption) (*ListEventsResponse, error) {
...
type SportServer interface {
	// ListEvents will return a collection of all sports.
	ListEvents(context.Context, *ListEventRequest) (*ListEventsResponse, error)
}
...
func (UnimplementedSportServer) ListEvents(context.Context, *ListEventRequest) (*ListEventsResponse, error) {
...
func _Sport_ListEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SportServer).ListEvents(ctx, req.(*ListEventRequest))
	}
