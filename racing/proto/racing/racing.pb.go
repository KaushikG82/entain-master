...
type RaceRequest struct {
	...
	Filter *RaceRequestFilter `protobuf:"bytes,1,opt,name=filter,proto3" json:"filter,omitempty"`
}
...
func (x *RaceRequest) GetFilter() *RaceRequestFilter {
	if x != nil {
		return x.Filter
	}
	return nil
...
func (x *RaceRequestFilter) Reset() {
	*x = RaceRequestFilter{}
	if protoimpl.UnsafeEnabled {
...
func (x *RaceRequestFilter) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RaceRequestFilter) ProtoMessage() {}

func (x *RaceRequestFilter) ProtoReflect() protoreflect.Message {
	mi := &file_racing_racing_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RaceRequestFilter.ProtoReflect.Descriptor instead.
func (*RaceRequestFilter) Descriptor() ([]byte, []int) {
	return file_racing_racing_proto_rawDescGZIP(), []int{1}
}

func (x *RaceRequestFilter) GetMeetingId() int64 {
	if x != nil {
		return x.MeetingId
	}
	return 0
...
type ListRacesRequestFilter struct {
	...
	OrderByAdvertiseTime bool `protobuf:"varint,3,opt,name=order_by_advertise_time,json=orderByAdvertiseTime,proto3" json:"order_by_advertise_time,omitempty"`
}
...
func (x *ListRacesRequestFilter) GetOrderByAdvertiseTime() bool {
	if x != nil {
		return x.OrderByAdvertiseTime
	}
	return false
}
...
var file_racing_racing_proto_rawDesc = []byte{
	...
	,
	...
	0x52, 0x04, 0x72, 0x61, 0x63, 0x65, 0x22, 0x4a, 0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x61,
	...
	0x52, 0x61, 0x63, 0x65, 0x52, 0x05, 0x72, 0x61, 0x63, 0x65, 0x73, 0x22, 0x8a, 0x01, 0x0a, 0x16,
	...
	0x65, 0x12, 0x35, 0x0a, 0x17, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x62, 0x79, 0x5f, 0x61, 0x64,
	0x76, 0x65, 0x72, 0x74, 0x69, 0x73, 0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x14, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x42, 0x79, 0x41, 0x64, 0x76, 0x65, 0x72,
	0x74, 0x69, 0x73, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xe3, 0x01, 0x0a, 0x04, 0x52, 0x61, 0x63,
	...
	0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0x84,
	...
	0x63, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x36, 0x0a,
	0x07, 0x47, 0x65, 0x74, 0x52, 0x61, 0x63, 0x65, 0x12, 0x13, 0x2e, 0x72, 0x61, 0x63, 0x69, 0x6e,
	0x67, 0x2e, 0x52, 0x61, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e,
	0x72, 0x61, 0x63, 0x69, 0x6e, 0x67, 0x2e, 0x52, 0x61, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f,
...
var file_racing_racing_proto_goTypes = []interface{}{
	(*RaceRequest)(nil),            // 0: racing.RaceRequest
	(*RaceRequestFilter)(nil),      // 1: racing.RaceRequestFilter
	(*RaceResponse)(nil),           // 2: racing.RaceResponse
...
var file_racing_racing_proto_depIdxs = []int32{
	1, // 0: racing.RaceRequest.filter:type_name -> racing.RaceRequestFilter
	6, // 1: racing.RaceResponse.race:type_name -> racing.Race
	...
	3, // 5: racing.Racing.ListRaces:input_type -> racing.ListRacesRequest
	0, // 6: racing.Racing.GetRace:input_type -> racing.RaceRequest
	4, // 7: racing.Racing.ListRaces:output_type -> racing.ListRacesResponse
	2, // 8: racing.Racing.GetRace:output_type -> racing.RaceResponse
...
func file_racing_racing_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_racing_racing_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RaceRequestFilter); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
