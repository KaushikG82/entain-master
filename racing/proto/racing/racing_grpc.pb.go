...
type RacingClient interface {
	...
	GetRace(ctx context.Context, in *RaceRequest, opts ...grpc.CallOption) (*RaceResponse, error)
}
...
func (c *racingClient) GetRace(ctx context.Context, in *RaceRequest, opts ...grpc.CallOption) (*RaceResponse, error) {
...
type RacingServer interface {
	...
	//To fetch single race object
	GetRace(context.Context, *RaceRequest) (*RaceResponse, error)
}
...
func (UnimplementedRacingServer) GetRace(context.Context, *RaceRequest) (*RaceResponse, error) {
...
func _Racing_GetRace_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RacingServer).GetRace(ctx, req.(*RaceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
